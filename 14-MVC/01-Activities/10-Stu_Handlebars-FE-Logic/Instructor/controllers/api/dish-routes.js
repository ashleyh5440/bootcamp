...
// updates a dish record using the id in the path
router.put('/:id', async (req, res) => {
  // TODO: Where is this action method sending the data from the body of the fetch request? Why?
  // Updating a record to the database. So the database will have the latest data from the user
  try {
    ...
    // res.status(200) says that the request was processed "ok"
    // .json(dish) will send back the number of records that were updated
