...
When I test the `sum-price` GET route in Postman, summary statistics for only books that are in stock should be returned.

## Actual Behavior

When I test the `sum-price` GET route in Postman, summary statistics for all books are returned.
...
2. Navigate to Postman on your local machine and test the `sum-price` GET route.
