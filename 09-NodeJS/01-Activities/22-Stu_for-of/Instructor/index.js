...
// console.log(outputCyanText("Test"));
// console.log(console.log(`\x1b[36m${"Test"}\x1b[0m`)); // void returns are basically undefined
// remove the outer console log here

// for(const single of array){
for(const single of songs) {
  outputCyanText(single);
}
