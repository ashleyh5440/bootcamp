...
// 1. rest - turns arguments into arrays
function add(...nums) {
// // rest will only take arguments that don't have a defined param name
// function add(first, ...nums) {
  // console.log(nums);
  let sum = 0;
...
// 1. spread - "copy and paste" as code looks like "..."
...
const equipment = ["crown", "ring", "poison flask", ...weapons];

// equipment.unshift(...weapons);
